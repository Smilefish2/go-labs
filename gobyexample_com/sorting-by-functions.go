...
// sortingByFunctionsCmd represents the sorting by functions command
var sortingByFunctionsCmd = &cobra.Command{
	Use:   "go-by-example:sorting-by-functions",
	Short: "https://gobyexample.com/sorting-by-functions",
...
func init() {
	cmd.RootCmd.AddCommand(sortingByFunctionsCmd)
}
