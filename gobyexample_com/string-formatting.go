...
// stringFormattingCmd represents the string formatting command
var stringFormattingCmd = &cobra.Command{
	Use:   "go-by-example:string-formatting",
	Short: "https://gobyexample.com/string-formatting",
...
func init() {
	cmd.RootCmd.AddCommand(stringFormattingCmd)
}
